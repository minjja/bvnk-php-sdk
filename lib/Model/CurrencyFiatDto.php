...
/**
 * CurrencyFiatDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CurrencyFiatDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyFiatDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fiat', $data ?? [], true);
        $this->setIfExists('icon', $data ?? [], null);
        $this->setIfExists('id', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('options', $data ?? [], null);
        $this->setIfExists('price_precision', $data ?? [], 2);
        $this->setIfExists('protocols', $data ?? [], null);
        $this->setIfExists('quantity_precision', $data ?? [], 2);
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The currency code.
     *
     * @return self
     */
     ...
     * Sets deposit_fee
     *
     * @param float|null $deposit_fee The % fee to deposit the currency.
     *
     * @return self
     */
     ...
     * Sets fiat
     *
     * @param bool|null $fiat Is a fiat currency.
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon The icon of the currency.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The currency name.
     *
     * @return self
     */
     ...
     * Sets options
     *
     * @param object|null $options The currency options.
     *
     * @return self
     */
     ...
     *
     * @param int|null $price_precision The precision of decimal points for the currency.
     *
     * @return self
     */
     ...
     * Sets protocols
     *
     * @param mixed[]|null $protocols The alternative protocols array.
     *
     * @return self
     */
     ...
     *
     * @param int|null $quantity_precision The precision of decimal points for the currency displayed.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $supports_deposits Is deposits for this currency supported.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $supports_withdrawals Is withdrawals for this currency supported
     *
     * @return self
     */
     ...
     * Sets withdrawal_fee
     *
     * @param float|null $withdrawal_fee The % fee to withdraw this currency.
     *
     * @return self
     */
     ...
     *
     * @param mixed[]|null $withdrawal_parameters The withdrawal parameter object.
     *
     * @return self
     */
